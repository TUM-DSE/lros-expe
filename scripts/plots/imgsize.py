...
def main():
    ...
    plot = sns.barplot(ax=ax, data=data_melt, x ="System", y ="imgMB", hue="System"
    ...
    plt.tight_layout()
    plt.grid()
    plt.savefig(os.path.join(plots_dir, "img_size.pdf"), format="pdf", pad_inches=0, bbox_inches="tight")
